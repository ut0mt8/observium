...
$config['page_title_prefix'] = "Iguane Observium :: ";
...
$config['autodiscovery']['xdp']            = FALSE; // Autodiscover hosts via discovery protocols (CDP, LLDP, FDP, AMAP and other)
$config['autodiscovery']['ospf']           = FALSE; // Autodiscover hosts via OSPF
$config['autodiscovery']['bgp']            = FALSE; // Autodiscover hosts via iBGP
$config['autodiscovery']['snmp_scan']      = FALSE; // Autodiscover hosts via SNMP scanning - currently not implemented. (FIXME)
$config['autodiscovery']['libvirt']        = FALSE; // Autodiscover hosts found via libvirt
$config['autodiscovery']['vmware']         = FALSE; // Autodiscover hosts found via vmware
...
$config['poller-wrapper']['alerter']       = FALSE;      // Execute alerter.php after poller.php
...
$config['enable_rip']                   = 0; // Enable RIP session collection and display
$config['enable_ospf']                  = 0; // Enable OSPF session collection and display
$config['enable_isis']                  = 1; // Enable ISIS session collection and display
$config['enable_eigrp']                 = 0; // Enable EIGRP session collection and display
$config['enable_syslog']                = 0; // Enable Syslog
$config['enable_vrfs']                  = 1; // Enable VRFs
$config['enable_printers']              = 0; // Enable Printer support
$config['enable_sla']                   = 0; // Enable SLA/RPM collection and display
...
$config['mibs']['OSPF-MIB']['enable']                          = 0;
$config['mibs']['EIGRP-MIB']['enable']                         = 0;
$config['mibs']['CISCO-MAC-ACCOUNTING-MIB']['enable']          = 0;
$config['mibs']['JUNIPER-MAC-MIB']['enable']                   = 0;
$config['mibs']['IP-MIB']['enable']                            = 1;
$config['mibs']['IPV6-MIB']['enable']                          = 0;
$config['mibs']['CISCO-IETF-IP-MIB']['enable']                 = 0;
...
$config['mibs']['BRIDGE-MIB']['enable']                        = 0;
$config['mibs']['HOST-RESOURCES-MIB']['enable']                = 1;
$config['mibs']['Juniper-UNI-ATM-MIB']['enable']               = 0;
